...
import homeLogoPurple from '../assets/images/logos/coin_ats.svg'
import foreignLogoPurple from '../assets/images/logos/coin_ats20.svg'
...
export class Bridge extends React.Component {
  ...
  render() {
    ...
    return(
      <div className="bridge-container-background">
